...
DEFAULT_GIT_REPO=https://github.com/simpleledger/Electron-Cash-SLP
if [ -z "$GIT_REPO" ] ; then
...
PACKAGE="Electron-Cash-SLP"  # Modify this if you like -- Windows, MacOS & Linux srcdist build scripts read this, while AppImage has it hard-coded
