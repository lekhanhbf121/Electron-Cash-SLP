...
build_secp256k1() {
    ...
    (
        ...
        LIBSECP_VERSION="69ccf0d2f758b1a4df9cde8222459381e08fc1dc"  # According to Mark B. Lundeberg, using a commit hash guarantees no repository man-in-the-middle funny business as git is secure when verifying hashes.
